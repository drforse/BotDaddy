    ...
    try:
        ...
        if not bydlos['done']:
            ...
            if m.chat.username:
                ...
                await asyncio.sleep(1)
                await bot.send_message(m.chat.id, f'{main_bydlo_first_name}, {main_bydlo_first_name}, вредный хуй!', reply_to_message_id=m.message_id)
            else:
                await bot.send_message(m.chat.id,
...
async def send_winrate(m):
    try:
        if m.reply_to_message and m.reply_to_message.text:
            if m.reply_to_message.from_user.id == 121913006 or m.reply_to_message.forward_from.id == 121913006:
            ...
            elif m.reply_to_message.from_user.id == 443471829 or m.reply_to_message.forward_from.id == 443471829:
